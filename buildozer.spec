...
# (string) Presplash background color (for android/ios)
...
android.permissions = INTERNET,ACCESS_NETWORK_STATE,ACCESS_WIFI_STATE,CHANGE_WIFI_STATE,ACCESS_COARSE_LOCATION,ACCESS_FINE_LOCATION,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE
...
# 1) android.add_assets = file1.txt,dir1
# 2) android.add_assets.1 = file1.txt
#    android.add_assets.2 = dir1
#android.add_assets =

# (list) Put these files or directories in the apk res directory.
# The option may be used in 2 ways, the old way and the new way.
# With the new way, you can group your files and control their location
# in the res directory.
# 1) android.add_res = my_data_dir  # deprecated, please use 2)
# 2) android.add_res.my_data_dir = my_data_dir  # puts my_data_dir in res/my_data_dir
#android.add_res =
...
# (str) optional file to store the Android SDK path
# this folder must contain the 25.0.2 build tools (specific version),
# and the platforms directory with platform-29 API (specific API level)
...
# Run `buildozer android p4a -- --help` to see available options
# bootstrap = sdl2
...
# Also available in the Keychain Access Certificates.
